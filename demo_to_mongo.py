...
def events_to_mongo(players, events, match_name, match_number, map_name):
    event_list = []
    round_number = 1
    event_number = 0
    round_prestart = 0
...
for demo_file in tqdm(match_name_number):#tqdm(matches_test)
    ...
    events_to_mongo(steam_ids, events, match_name, match_number, map_name)
    #except:
